...
export const Licenses = () => {
  // البيانات الرسمية المستخرجة بدقة من وثيقة السجل التجاري المرفقة
  const licenseData = {
  ...
  return (
    <section
      // خلفية متسقة ممتدة بنعومة من تدرج الرمادي الرملي الدافئ إلى العاجي الصافي الفاخر
    ...
    >
      <div className="container mx-auto px-4 relative z-10">
        {/* العنوان الرئيسي للقسم بأسلوب رصين وفخم يعكس الثقة والموثوقية */}
        <div className="text-center mb-12 max-w-2xl mx-auto">
          {/* Refactor: تحويل اللون الأخضر الحاد إلى شارة برونزية دافئة تليق بالنخبة */}
        ...
        {/* كرت عرض بيانات السجل التجاري بتصميم زجاجي عاجي فخم وناصع */}
        <div className="max-w-3xl mx-auto bg-white/95 backdrop-blur-md rounded-2xl p-6 sm:p-8 border border-white shadow-xl shadow-[#C4BCB0]/15 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          {/* الجانب الأيمن: تفاصيل السجل التجاري والبيانات الأساسية */}
          <div className="md:col-span-8 space-y-5">
            ...
            {/* تفاصيل البيانات على شكل قائمة أنيقة واضحة القراءة */}
          ...
          {/* الجانب الأيسر: رمز الـ QR والتوثيق الرقمي السريع بخلفية كريمية ناعمة */}
          <div className="md:col-span-4 flex flex-col items-center justify-center bg-linear-to-b from-[#FAF8F5] to-[#F4F0E6]/70 p-5 rounded-xl border border-[#D6CFC4]/40 text-center">
            {/* صندوق الـ QR المحدث لاستقبال الصورة الحقيقية */}
