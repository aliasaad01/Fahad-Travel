...
export const Stats = () => {
  ...
  return (
    ...
    >
      {/* الخطوط العمودية والتأثيرات الضبابية لمحاكاة واجهات العرض الفاخرة المظلمة */}
        ...
        >
          {stats.map((stat, idx) => {
            ...
            return (
              ...
              >
                {/* الدائرة البصرية للأيقونة مع تأثير بريق ذهبي عند التحويم */}
                <div
