...
export const Stats = () => {
  ...
  return (
    <section
      // تم موازنة الخلفية لتتدفق بانسجام رغيد من تدرج الهيرو الرملي وتستقر في العاجي النقي المعتمد
    ...
    >
      {/* خطوط زخرفية عمودية ناعمة تتناسب مع الثيم الفاتح والأنيق */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        {/* Refactor: صياغة العنوان لتكون أكثر فخامة، هدوءاً وثقة وتجذب عملاء النخبة */}
        ...
        {/* شبكة الإحصائيات الحيوية لرحلات فهد للأزواج */}
        <div
          ...
          {stats.map((stat, idx) => {
            ...
            return (
              <motion.div
                ...
                // تعديل ملمس الكروت في الجوال لتتماشى مع زجاج العاج المعتمد
              ...
              >
                {/* الدائرة البصرية للأيقونة - ألوان كريمية وبرونزية متناسقة */}
                <div
                ...
                {/* الرقم الإحصائي الضخم بلون داكن ملكي ويتحول للبرونزي الدافئ عند التحويم */}
                <span
